# run_02_features.ps1 — Ejecuta todos los notebooks de 02_features en orden
# Uso: .\run_02_features.ps1

$JUPYTER  = "C:\Users\cuent\Documents\UAX\TFM\TFM\venv\Scripts\jupyter.exe"
$NB_DIR   = "$PSScriptRoot\02_features"
$TIMEOUT  = 600

$notebooks = @(
    "01_vitalsign_sequences.ipynb"
)
...
Write-Host "=== Features notebooks ($total) ===" -ForegroundColor Cyan
